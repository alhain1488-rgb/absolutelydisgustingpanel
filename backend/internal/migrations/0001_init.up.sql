-- Initial schema. Protocol-specific parameters live in JSON columns so new
-- protocols never require a schema change.
...
CREATE TABLE servers (
    ...
    ssh_auth_method    TEXT    NOT NULL,           -- 'key' | 'password'
